...
function CompanyListPage() {
  ...
  const { data, error, isLoading, mutate } = useSWR<CompanyInterface[]>(
    ...
    () =>
      getCompanies({
        relations: ['user', 'inquiry.count', 'invitation.count'],
      }),
  );
            ...
            <Table variant="simple">
              <Thead>
                <Tr>
                  ...
                  {hasAccess('inquiry', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && <Th>inquiry</Th>}
